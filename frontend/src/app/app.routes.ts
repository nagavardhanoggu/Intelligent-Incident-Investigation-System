  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'services',
        canActivate: [permissionGuard],
        data: { permissions: ['operations:services:view'], pageKey: 'service-health', pageSource: 'operations' },
        loadComponent: () => import('./features/feature-pages/feature-page.component').then(m => m.FeaturePageComponent),
      },
      {
        path: 'deployments',
        canActivate: [permissionGuard],
        data: { permissions: ['operations:deployments:view'], pageKey: 'deployments', pageSource: 'operations' },
        loadComponent: () => import('./features/feature-pages/feature-page.component').then(m => m.FeaturePageComponent),
      },
      {
        path: 'sla-monitor',
        canActivate: [permissionGuard],
        data: { permissions: ['operations:sla:view'], pageKey: 'sla-monitor', pageSource: 'operations' },
        loadComponent: () => import('./features/feature-pages/feature-page.component').then(m => m.FeaturePageComponent),
      },
      {
        path: 'alert-rules',
        canActivate: [permissionGuard],
        data: { permissions: ['operations:alerts:view'], pageKey: 'alert-rules', pageSource: 'operations' },
        loadComponent: () => import('./features/feature-pages/feature-page.component').then(m => m.FeaturePageComponent),
      },
      {
        path: 'change-calendar',
        canActivate: [permissionGuard],
        data: { permissions: ['operations:changes:view'], pageKey: 'change-calendar', pageSource: 'operations' },
        loadComponent: () => import('./features/feature-pages/feature-page.component').then(m => m.FeaturePageComponent),
      },
      {
        path: 'on-call',
        canActivate: [permissionGuard],
        data: { permissions: ['operations:oncall:view'], pageKey: 'on-call', pageSource: 'operations' },
        loadComponent: () => import('./features/feature-pages/feature-page.component').then(m => m.FeaturePageComponent),
      },
      {
        path: 'root-cause',
        canActivate: [permissionGuard],
        data: { permissions: ['operations:rootcause:view'], pageKey: 'root-cause', pageSource: 'operations' },
        loadComponent: () => import('./features/feature-pages/feature-page.component').then(m => m.FeaturePageComponent),
      },
      {
        path: 'reports',
      ...
      {
        path: 'content/:source/:pageKey/:detailKey',
        loadComponent: () => import('./features/feature-pages/feature-page-detail.component').then(m => m.FeaturePageDetailComponent),
      },
      {
